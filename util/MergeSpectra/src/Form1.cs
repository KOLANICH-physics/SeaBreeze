...
partial class Form1: Form {
	...
	class PeakInfo {
	  ...
	  public
		PeakInfo(double wavelength_in, double intensity_in, double fwhm_in) {
  ...
  private
	void buttonSelectInputFiles_Click(object sender, EventArgs e) {
  ...
  private
	void checkBoxInterpolate_CheckedChanged(object sender, EventArgs e) {
  ...
  private
	void checkBoxGraph_CheckedChanged(object sender, EventArgs e) {
		enableGraph = checkBoxGraph.Checked;
	}

  private
	void checkBoxEnablePeakFinding_CheckedChanged(object sender, EventArgs e) {
  ...
  private
	void numericUpDownMinIndicesBetweenPeaks_ValueChanged(object sender, EventArgs e) {
  ...
  private
	void radioButtonLibrarySPAM_CheckedChanged(object sender, EventArgs e) {
		peakFindingAlgo = PeakFindingAlgos.SPAM_ALGO;
		groupBoxSolver.Enabled = false;
	}

  private
	void radioButtonLibrarySolver_CheckedChanged(object sender, EventArgs e) {
		peakFindingAlgo = PeakFindingAlgos.SOLVER_ALGO;
		groupBoxSolver.Enabled = true;
	}

  private
	void numericUpDownGaussianHalfWidth_ValueChanged(object sender, EventArgs e) {

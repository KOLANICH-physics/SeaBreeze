...
class SpectrometerSeaBreeze: SpectrometerInterface {
  ...
  public
	static SpectrometerSeaBreeze getInstance() {
		mut.WaitOne();
		if(instance == null)
...
class FeatureControllerGPIO {
  ...
  public
	bool setValueBit(int pin, int newValue) {

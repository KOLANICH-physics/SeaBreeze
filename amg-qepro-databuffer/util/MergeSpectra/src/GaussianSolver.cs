...
class GaussianSolver {
  ...
  public
	class Params {
	  ...
	  public
		...
		// ctor
	  public
		Params(double i, double wl, double w, double b) {
			intensity = i;
			wavelength = wl;
			width = w;
			baseline = b;
  ...
  public
	GaussianSolver(double intensity, double wavelength, double width, double baseline) {
  ...
  public
	double computeFWHM() {
		...
		double[] coeffs = new double[] {initialParams.intensity,
